...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4 equal-column @if(!session('business.enable_category')) hide @endif">
            <div class="form-group">
                {!! Form::label('category_id', __('product.category') . ':') !!} {!! Form::select('category_id', $categories, !empty($duplicate_product->category_id) ? $duplicate_product->category_id : !empty($data['category_id'])?$data['category_id']:null, ['placeholder' =>
        ...
        <div class="col-sm-4 equal-column @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
            <div class="form-group">
                {!! Form::label('sub_category_id', __('product.sub_category') . ':') !!} {!! Form::select('sub_category_id', $sub_categories, !empty($duplicate_product->sub_category_id) ? $duplicate_product->sub_category_id :  !empty($data['sub_category_id'])?$data['sub_category_id']:null,
