    ...
    <div class="modal-body">
      ...
      <div class="row payment_row">
        ...
        <div class="col-md-4 cheque_return_charges_div hide">
          ...
          <!--  <select name="bank_name" id="cheque_bank" class=" form-control select2 cheque_bank">-->
          <!--    <option value="selected disabled"> {{ __('lang_v1.please_select') }}</option>-->
          <!--    @if(!empty($cheque_banks))-->
          <!--      @foreach($cheque_banks as $bank)-->
