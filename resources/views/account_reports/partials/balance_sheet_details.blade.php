    ...
    <div class="col-md-6">
        ...
        <table class="table table-border table-striped">
            <tbody>
                ...
                @foreach ($equity_accounts_main_balances as $account_detail)
                <tr>
                    <td>{{$account_detail->name}}</td>
                    <td>{{@num_format(($account_detail->balance))}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>{{@num_format($tl_equity_accounts_main_balances)}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td><b>{{@num_format(@$lt_liabilities_accounts->sum('balance') +  @$lt_liabilities_accounts_main_balances_total + @$liabilities_accounts->sum('balance') + @$liabilities_accounts_main_balances_total + @$tl_equity_accounts_main_balances)}}</b></td>
                </tr>
                @endif
            </tbody>
