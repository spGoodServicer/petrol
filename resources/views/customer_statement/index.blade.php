...
<script type="text/javascript">
    $(document).ready( function(){
        ...
        $('#customer_statement_date_range, #customer_statement_location_id, #customer_statement_customer_id').change(function(){
            ...
            console.log('Customer Id', $('#customer_statement_customer_id').val());
            $.ajax({
                method: 'get',
        ...
        $.ajax({
            ...
            success: function(result) {
                if(result.success == 1){
                    ...
                    var finalDueAmountColumn = table.column( 11 );

                    due_total = (finalDueAmountColumn.data().length > 0) && finalDueAmountColumn.data().reduce( function (a,b) {
                        return parseInt(a)+parseInt(b);
                    });

                  console.log(due_total);
                    $('#due_total').val(due_total);
                    balance_total = __number_f($('#balance_due').val());
                    due_total = __number_f(due_total);
