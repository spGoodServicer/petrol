...
class AddPaymentController extends Controller
{
    ...
    public function getCustomerDetails($customer_id, ContactController $contactController)
    {
        ...
        return ['total_outstanding' =>  strval($contactController->get_due_bal($customer_id, false)), 'credit_limit' => strval($credit_limit), 'customer_references' => $customer_references];
    }
