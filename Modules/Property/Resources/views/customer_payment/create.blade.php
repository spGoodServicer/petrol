      ...
      <div class="row">
        <div class="col-md-12 col-lg-12 ">
          <div class="row">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                {!! Form::label('installment', __('property::lang.installment_start_on')) !!}
                {!! Form::text('original_amount', null, ['class' => 'form-control reset
                original_amount', 'readonly', 'placeholder' => __('property::lang.installment_start_on'), 'id' =>
                'original_amount',]); !!}
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                {!! Form::label('installment', __('property::lang.installment_ends_on')) !!}
                {!! Form::text('original_amount', null, ['class' => 'form-control reset
                original_amount', 'readonly', 'placeholder' => __('property::lang.installment_ends_on'), 'id' =>
                'original_amount']); !!}
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                ...
                installment', 'readonly', 'placeholder' => __('property::lang.installment'), 'id' =>
                'installment']); !!}
              </div>
            </div>
          </div>
