<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('PAY_ONLINE_STARTING_NO', 'Notes:') !!}
                {!! Form::text('PAY_ONLINE_STARTING_NO', $default_values['PAY_ONLINE_STARTING_NO'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('PAY_ONLINE_LIVE', 'Is Live?') !!}
                {!! Form::select('PAY_ONLINE_LIVE',['false' => 'False', 'true' => 'True'],  !empty($default_values['PAY_ONLINE_LIVE'])?'true':'flase', ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="clearfix"></div>
