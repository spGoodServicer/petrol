            ...
            return DataTables::of($fleets)
                ->addColumn(
                    ...
                    <ul class="dropdown-menu dropdown-menu-left" role="menu">';
                        ...
                        $html .= '<li><a href="' . action('\Modules\Ezyboat\Http\Controllers\EzyboatController@show', [$row->id]) . '?tab=income" class="" ><i class="fa fa-money-bill"></i> ' . __("fleet::lang.income") . '</a></li>';
