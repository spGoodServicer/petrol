<li class="nav-item {{ in_array($request->segment(1), ['sms']) ? 'active active-sub' : '' }}">
    <a class="nav-link" href="#"><i class="fa fa-lg fa-comments-o nav-icon"></i> <p>@lang('sms::lang.sms')<i class="right fas fa-angle-left"></i></p>
   ...
   <ul class="nav nav-treeview">
        ...
        <li class="nav-item {{ $request->segment(1) == 'sms' && $request->segment(2) == ''? 'active' : '' }}">
            <a href="nav-link {{action('\Modules\SMS\Http\Controllers\SMSController@index')}}"><i
