...
class ProductUtil extends Util
{
    ...
    public function getVariationStockHistory($business_id, $variation_id, $location_id, $store_id = null)
    {
...
;             
        ...
        //     $stock_history = $stock_history->get();
        // }else{
        //     $stock_history = $stock_history->where('transactions.store_id', $store_id)
        //                         ->get();
        // }
